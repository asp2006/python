...
GITHUB_RAW_URL = "https://raw.githubusercontent.com/username/repository/main/"  # آدرس مخزن خود را اینجا وارد کنید
...
def get_exercise_code(exercise_number):
    url = f"{GITHUB_RAW_URL}{exercise_number}.py"  # URL فایل کد تمرین
    try:
        response = requests.get(url)
        response.raise_for_status()  # بررسی وضعیت درخواست
        return response.text  # بازگشت متن کد تمرین
