# هدف: معرفی و کار با تاپل‌ها در پایتون، شامل دسترسی به عناصر، پیمایش، بررسی وجود عنصر، تعریف تاپل تک‌عنصری، استفاده از تاپل برای ذخیره اطلاعات و تلاش برای تغییر داده‌های آن
